...
public:
	...
	{
		cue->AddObserver(vtkCommand::StartAnimationCueEvent, this, &VTKActorAnimator::Start);
		cue->AddObserver(vtkCommand::EndAnimationCueEvent, this, &VTKActorAnimator::End);
		cue->AddObserver(vtkCommand::AnimationCueTickEvent, this, &VTKActorAnimator::Tick);
	}
